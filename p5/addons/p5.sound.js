 ...
 *   - TONE.libs (c) Yotam Mann. Licensed under The MIT License (MIT). https://github.com/TONEnoTONE/Tone.js
 *   - buzz.libs (c) Jay Salvat. Licensed under The MIT License (MIT). http://buzz.jaysalvat.com/
 *   - Boris Smus Web Audio API book, 2013. Licensed under the Apache License http://www.apache.org/licenses/LICENSE-2.0
 *   - wavesurfer.libs https://github.com/katspaugh/wavesurfer.js
...
/**
 * Determine which filetypes are supported (inspired by buzz.libs)
...
function () {
  ...
  effect_createClass(Effect, [{
    ...
    /**
     *  Send output to a p5.libs-sound, Web Audio Node, or use signal to
  ...
  soundLoop_createClass(SoundLoop, [{
    ...
    value: function _convertNotation(value) {
      ...
      switch (type) {
        ...
        default:
          console.warn('Specified interval is not formatted correctly. See Tone.libs ' + 'timing reference for more info: https://github.com/Tonejs/Tone.js/wiki/Time');
      }
    }
    /**
...
var Signal_Signal = function Signal() {
  ...
  console.warn('p5.Signal is deprecated , Use Tone.libs Signal instead ');
};
